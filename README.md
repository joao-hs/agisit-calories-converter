...
```
cd existing_repo
git remote add origin https://gitlab.rnl.tecnico.ulisboa.pt/agisit/agisit24-g10.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.rnl.tecnico.ulisboa.pt/agisit/agisit24-g10/-/settings/integrations)
